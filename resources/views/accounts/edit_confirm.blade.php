...
@section('content')
	<section>
		<div class="block">
			...
			<div class="inner">
				<form id="editAccountForm" method="POST" action="{{ route('accounts.checkCancelOrUpdate', $user) }}">
					@csrf
					...
					<div class="block block-marginCenter block-spaceL" style="width: 500px;">
						<table class="table table-form table-conf">
							...
							<tbody>
								...
								<tr>
									...
									<td class="table_data">{{ config('constants.authority')[$user->authority] }}</td>
								</tr>
							</tbody>
						</table>
						...
						<ul class="block block-positionCenter block-spaceM cf">
							...
							<li class="btn btn-button btn-inline btn-leftSpaceL">
								<button id="editAccount" type="submit" name="send" value="登録" class="btn_link btn_link-icon btn_link-iconPen" tabindex="1">登録</button>
							</li>
						</ul>
